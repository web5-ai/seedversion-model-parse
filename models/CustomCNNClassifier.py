...
轻量级的自定义CNN模型，用于种子识别的二分类任务（背景/种子）
适配项目的模型加载和推理框架
"""
...
class CustomCNNClassifier(nn.Module):
    ...
    def get_model_info(self):
        ...
        return {
            'model_name': 'CustomCNNClassifier',
...
if __name__ == '__main__':
    # 测试模型创建
    print("测试 CustomCNNClassifier 模型...")
    
    model = CustomCNNClassifier(num_classes=2, device='cpu')
    ...
    print("CustomCNNClassifier 测试完成！")
