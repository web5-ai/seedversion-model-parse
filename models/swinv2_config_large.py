...
# Model name
_C.MODEL.NAME = 'swinv2_large_patch4_window12_192_22k'
...
_C.MODEL.SWIN.EMBED_DIM = 192
_C.MODEL.SWIN.DEPTHS = [2, 2, 18, 2]
_C.MODEL.SWIN.NUM_HEADS = [6, 12, 24, 48]
...
_C.MODEL.SWINV2.WINDOW_SIZE = 8 # 问题
